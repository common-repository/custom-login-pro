...
/* Slider Option                                        */
/* ---------------------------------------------------- */
function clp_get_slider_markup($cssName, $name, $default = 'inherit', $decimals, $pxv, $pcv, $emv,$note = null){
    ...
    // Default
    if ($default !== false) {
        $defaultLink = "<a class='clp-btn-action clp-none-btn' data-default='".$default."'>" . $default . "</a>";
    } else {
        $defaultLink = '';
    }

    // Option HTML
    return "<div id='" . $cssName . "-group' class='clp-option-group clp-slider-option' data-css='" . $cssName . "' data-css-id='" . clp_css_id($cssName) . "' data-decimals='" . $decimals . "' data-px-range='" . $pxv . "' data-pc-range='" . $pcv . "' data-em-range='" . $emv . "'><div class='clp-part'><label class='clp-option-label'><span".$tooltip.">" . $name . ":</span><i class='phone-icon'></i> " . $defaultLink . " <a class='clp-btn-action clp-disable-btn'></a></label><div id='clp-" . $cssName . "' class='clp-slider-div'></div><div class='clp-after'><input type='text' id='" . $cssName . "-value' class='clp-after-css clp-after-css-val' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' /><input type='text' id='" . $cssName . "-after' class='clp-after-css clp-after-prefix' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' /><small>(px em %)</small></div></div></div>";
...
/* Select Option                                        */
/* ---------------------------------------------------- */
function clp_get_select_markup($cssName, $name, $values, $default = 'none', $note = null){
    ...
    if ($cssName == 'animation-name' && $default != false) {
        ...
        $defaultLink = "<span class='dashicons dashicons-controls-play anim-player-icon'></span><a class='clp-visual-editor-link'>Animator</a><a class='clp-btn-action clp-none-btn' data-default='".$default."'>" . $default . "</a>";

    }
    
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='clp-option-group clp-select-option' data-css='" . $cssName . "' data-css-id='" . clp_css_id($cssName) . "'><div class='clp-part'><label class='clp-option-label'><span".$tooltip.">" . $name . ":</span><i class='phone-icon'></i> " . $defaultLink . " <a class='clp-btn-action clp-disable-btn'></a></label><select id='clp-" . $cssName . "-data' class='clp-select-data'>";
    ...
    // End Option
    $return .= "</select><input id='clp-" . $cssName . "' type='text' class='input-autocomplete' value='' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' /><div id='clp-autocomplete-place-" . $cssName . "' class='autocomplete-div'></div></div></div>";
...
/* Radio Option                                         */
/* ---------------------------------------------------- */
function clp_get_radio_markup($cssName, $name, $values, $default = 'none',$note = null){
    ...
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='clp-option-group clp-radio-option' data-css='" . $cssName . "' data-css-id='" . clp_css_id($cssName) . "'><div class='clp-part'><label class='clp-option-label'><span".$tooltip.">" . $name . ":</span><i class='phone-icon'></i> " . $defaultLink . " <a class='clp-btn-action clp-disable-btn'></a></label><div class='clp-radio-grid-" . count($values) . " clp-radio-content' id='clp-" . $cssName . "'>";
    
    // Radio Settings
    foreach ($values as $key => $value) {
        $return .= '<div class="clp-radio"><input type="radio" name="' . $cssName . '" value="' . $key . '" id="s-'.$cssName.'-' . $key . '"><label id="'.$cssName.'-' . $key . '" data-for="s-'.$cssName.'-' . $key . '" class="clp-update">' . $value . '</label></div>';
    }
    
    // Close
    $return .= "<div class='clp-clear'></div></div></div></div>";
...
/* Colorpicker Option                                    */
/* ---------------------------------------------------- */
function clp_get_color_markup($cssName, $name,$note = null){
    ...
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='clp-option-group clp-color-option' data-css='" . $cssName . "' data-css-id='" . clp_css_id($cssName) . "'><div class='clp-part'><label class='clp-option-label'><span".$tooltip.">" . $name . ":</span><i class='phone-icon'></i> <a class='clp-btn-action clp-none-btn'>transparent</a> <a class='clp-btn-action clp-disable-btn'></a></label><div class='clp-color-input-box'><input id='clp-" . $cssName . "' type='text' maxlength='22' size='22' class='wqcolorpicker' value='' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' /><span class='clp-color-background'><span class='wqminicolors-swatch-color'></span></span><span class='color-picker-icon clp-element-picker'></span></div><div class='clp-after'><a class='clp-flat-colors'>Flat</a> <a class='clp-meterial-colors'>Material</a> <a class='clp-nice-colors'>Trend</a><div class='clp-clear'></div><div class='clp_flat_colors_area'>";

    	// Flat COlors
		foreach ($flatArray as $color) {
				$return .= "<div class='clp-flat-c' data-color='#".$color."' style='background:#".$color."'></div>";
			}
		$return .= "</div>";
		
		// Meterial Colors	
		$return .= "<div class='clp_meterial_colors_area'>";
		foreach ($meterialArray as $color) {
			$return .= "<div class='clp-meterial-c' data-color='#".$color."' style='background:#".$color."'></div>";
		}
		$return .= "</div>";
		
		// Nice Colors		
		$return .= "<div class='clp_nice_colors_area'>";
		foreach ($niceArray as $color) {
			$return .= "<div class='clp-nice-c' data-color='#".$color."' style='background:#".$color."'></div>";
		}
...
/* Input Option   		                                */
/* ---------------------------------------------------- */
function clp_get_input_markup($cssName, $name, $none = null, $note = null){
    ...
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='clp-option-group clp-input-option' data-css='" . $cssName . "' data-css-id='" . clp_css_id($cssName) . "'><div class='clp-part'><label class='clp-option-label'><span".$tooltip.">" . $name . ":</span><i class='phone-icon'></i> <a class='clp-btn-action clp-none-btn' data-default='".$none."'>".$none."</a> <a class='clp-btn-action clp-disable-btn'></a></label><input autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' id='clp-" . $cssName . "' type='text' class='clp-input' value='' />";

    // List Style Image
    if($cssName == 'list-style-image'){
    	$return .= "<a class='clp-gallery-btn clp-upload-btn'>Upload Image</a><div style='clear:both;'></div>";
    }
	
	// Background Image
	if($cssName == "background-image"){

		$images = glob(CLP_PLUGIN_DIR.'/assets/*.{png,jpg,jpeg}', GLOB_BRACE);
		$return .= "<div style='clear:both;'></div><a class='clp-gallery-btn clp-upload-btn'>Upload Image</a><a class='clp-gradient-btn'>Gradients</a><div style='clear:both;'></div>";
		...
		foreach ($gradients as $gradient) {
			$gradientList .= '<div class="clp-gradient-demo" data-gradient="'.$gradient.'"><span style="background-image:'.$gradient.'"></span> '.$gradientNames[$i].'</div>';
			$i++;

		}

		// Background gradient section starts
		$return .= '<div class="clp-gradient-section"><div class="clp-gradient-list">'.$gradientList.'</div><div class="uigradient-api">by <a href="https://uigradients.com">uiGradients</a></div><div class="clp-gradient-bar-background"><div class="clp-gradient-bar"></div></div><div class="clp-gradient-pointer-area"></div><input id="iris-gradient-color" type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" /><div class="clp-gradient-space"></div><div class="clp-gradient-orientation" data-degree="90"><b>Orientation</b><i></i></div></div>';
...
/* Input Option   		                                */
/* ---------------------------------------------------- */
function clp_get_textarea_markup($cssName, $name, $none = null, $note = null){
    ...
    // Option HTML
    $return = "<div id='" . $cssName . "-group' class='clp-option-group clp-input-option' data-css='" . $cssName . "' data-css-id='" . clp_css_id($cssName) . "'><div class='clp-part'><label class='clp-option-label'><span".$tooltip.">" . $name . ":</span><i class='phone-icon'></i> <a class='clp-btn-action clp-none-btn' data-default='".$none."'>".$none."</a> <a class='clp-btn-action clp-disable-btn'></a></label><textarea autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' id='clp-" . $cssName . "' type='text' class='clp-textarea'></textarea>";
    $return .= "</div></div>";
