...
// arrow icon for list
$arrow_icon = "<span class='dashicons clp-arrow-icon dashicons-arrow-up'></span><span class='dashicons clp-arrow-icon dashicons-arrow-down'></span>";

/* ---------------------------------------------------- */
/* All CSS Options and settings							*/
/* ---------------------------------------------------- */
echo "<ul class='clp-editor-list'>
		
		<li class='text-option'>
		
			<h3>Text ".$arrow_icon."</h3>
			<div class='clp-this-content'>

				".clp_get_select_markup(
					'font-family',
					'Font Family',
					array(
		...
		<li class='border-option'>
			...
			<div class='clp-this-content'>
				...
				<div class='clp-border-all-section'>
				...
				<div class='clp-border-top-section'>
				...
				<div class='clp-border-right-section'>
				...
				<div class='clp-border-bottom-section'>
				...
				<div class='clp-border-left-section'>
		...
		<li class='size-option'>
			<h3>Size <span class='clp-badge clp-lite'>Pro</span> ".$arrow_icon."</h3>
			<div class='clp-this-content'>
		...
		<li class='animation-option'>
			<h3>Animation <span class='clp-badge clp-lite'>Pro</span> <span class='clp-badge clp-anim-recording'>Rec</span> ".$arrow_icon."</h3>
			<div class='clp-this-content'>";
				...
				foreach($all_options as $name => $value){
					if(stristr($name, 'clp_anim')){
						$name = str_replace("clp_anim_", "", $name);
						$animations[$name] = ucwords(strtolower($name));
					}
				}
				
				echo " ".clp_get_select_markup(
					'animation-name',
					'Animation',
					$animations,
					"none",
		...
		<li class='extra-option'>
			...
			<div class='clp-this-content'>";
				...
				echo "<a class='clp-advanced-link clp-top clp-special-css-link clp-filter-link'>Filters</a>
				<div class='clp-advanced-option clp-special-css-area clp-filter-area'>
				...
				echo "<a class='clp-advanced-link clp-top clp-special-css-link clp-transform-link'>Transform</a>
				<div class='clp-advanced-option clp-special-css-area clp-transform-area'>
